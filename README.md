...
The code can be used to create any gauge with a 360 degree range, see comments in the .ino file for set up and calibration details - here we are using a 270 degree range and an MQTT feed of wind speed.
